<div class="plan-editor">
  ...
  <!-- Plan Details Tab -->
  <form [formGroup]="planForm" class="plan-form" *ngIf="activeTab() === 'details'">
  ...
  <!-- Pricing Tiers Tab -->
  <div *ngIf="activeTab() === 'tiers'" class="tiers-tab">
    <div class="form-section">
  ...
  <!-- Features Tab -->
  <div *ngIf="activeTab() === 'features' && !isNewPlan()" class="features-tab">
    <app-plan-features [planIdInput]="plan()?.id || ''"></app-plan-features>
  </div>
  ...
  <div *ngIf="selectedTierId()" class="tier-editor-panel">
    <app-tier-editor
      ...
      (closeEditor)="selectedTierId.set(null)">
    </app-tier-editor>
  </div>
</div>

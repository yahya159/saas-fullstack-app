...
export type PrimitiveConstructorReturnType<TType extends PrimitiveConstructorExtended> = TType extends DateConstructor | Exclude<TType, PrimitiveConstructor> ? InstanceType<TType> : ReturnType<Extract<TType, PrimitiveConstructor>>;
...
export type NamingConventionInput = NamingConvention | {
...
export type ValueSelector<TSource extends Dictionary<TSource> = any, TDestination extends Dictionary<TDestination> = any, TValueReturn = SelectorReturn<TDestination>> = (source: TSource) => TValueReturn;
...
export type MapCallback<TSource extends Dictionary<TSource>, TDestination extends Dictionary<TDestination>, TExtraArgs extends Record<string, any> = Record<string, any>> = (source: TSource, destination: TDestination, extraArguments?: TExtraArgs) => void;
...
export type MapDeferReturn<TSource extends Dictionary<TSource>, TDestination extends Dictionary<TDestination>, TSelectorReturn = SelectorReturn<TDestination>> = [
    TransformationType.MapDefer,
    DeferFunction<TSource, TDestination, TSelectorReturn>
];
export type MapFromReturn<TSource extends Dictionary<TSource>, TDestination extends Dictionary<TDestination>, TSelectorReturn = SelectorReturn<TDestination>> = [TransformationType.MapFrom, Selector<TSource, TSelectorReturn>];
export type MapWithReturn<TSource extends Dictionary<TSource>, TDestination extends Dictionary<TDestination>, TSelectorReturn = SelectorReturn<TDestination>> = [
...
export type ConditionReturn<TSource extends Dictionary<TSource>, TDestination extends Dictionary<TDestination>, TSelectorReturn = SelectorReturn<TDestination>> = [
    TransformationType.Condition,
    (source: TSource, sourceMemberPath: string[]) => TSelectorReturn
];
export type FromValueReturn<TSource extends Dictionary<TSource>, TDestination extends Dictionary<TDestination>, TSelectorReturn = SelectorReturn<TDestination>> = [TransformationType.FromValue, () => TSelectorReturn];
export type ConvertUsingReturn<TSource extends Dictionary<TSource>, TDestination extends Dictionary<TDestination>, TSelectorReturn = SelectorReturn<TDestination>> = [TransformationType.ConvertUsing, Selector<TSource, TSelectorReturn>];
export type NullSubstitutionReturn<TSource extends Dictionary<TSource>, TDestination extends Dictionary<TDestination>, TSelectorReturn = SelectorReturn<TDestination>> = [
    TransformationType.NullSubstitution,
    (source: TSource, sourceMemberPath: string[]) => TSelectorReturn
];
export type UndefinedSubstitutionReturn<TSource extends Dictionary<TSource>, TDestination extends Dictionary<TDestination>, TSelectorReturn = SelectorReturn<TDestination>> = [
...
export type MapWithArgumentsReturn<TSource extends Dictionary<TSource>, TDestination extends Dictionary<TDestination>, TSelectorReturn = SelectorReturn<TDestination>> = [
    TransformationType.MapWithArguments,
    (source: TSource, extraArguments: Record<string, any>) => TSelectorReturn
];
export type MapInitializeReturn<TSource extends Dictionary<TSource>, TDestination extends Dictionary<TDestination>, TSelectorReturn = SelectorReturn<TDestination>> = [
...
export type MappingTransformation<TSource extends Dictionary<TSource> = any, TDestination extends Dictionary<TDestination> = any, TSelectorReturn = SelectorReturn<TDestination>> = [
...
export type MappingProperty<TSource extends Dictionary<TSource>, TDestination extends Dictionary<TDestination>, TSelectorReturn = SelectorReturn<TDestination>> = [
    target: string[],
...
export type MappingConfiguration<TSource extends Dictionary<TSource> = any, TDestination extends Dictionary<TDestination> = any> = (mapping: Mapping<TSource, TDestination>) => void;
export type ApplyMetadataFn = <TModel extends Dictionary<TModel>>(model: MetadataIdentifier<TModel>, as: MetadataObjectMapClassId) => TModel;
export type ApplyMetadata = (strategy: MappingStrategy<MetadataIdentifier>) => ApplyMetadataFn;
export type DestinationConstructor<TSource extends Dictionary<TSource> = any, TDestination extends Dictionary<TDestination> = any> = (sourceObject: TSource, destinationIdentifier: MetadataIdentifier<TDestination>) => TDestination;
